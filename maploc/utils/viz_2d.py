...
def plot_images(imgs, titles=None, cmaps="gray", dpi=600, pad=0.01, adaptive=True):
...
def plot_images_poi(imgs, titles=None, cmaps="gray", dpi=600, pad=0.5, adaptive=True):
    """Plot a set of images horizontally.
    Args:
        imgs: a list of NumPy or PyTorch images, RGB (H, W, 3) or mono (H, W).
        titles: a list of strings, as titles for each image.
